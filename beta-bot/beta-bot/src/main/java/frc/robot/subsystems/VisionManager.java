...
public class VisionManager extends SubsystemBase{
    ...
    private PhotonVision shutterPC;
    ...
    public VisionManager(){
        ...
        shutterPC = new PhotonVision(VisionConstants.REAR_PC_NAME, VisionConstants.SHUTTER_TRANS);
    ...
    public Pose2d getFieldRelativePoseShutter(){
        return shutterPC.getBotPose();
    }

    public double getPoseTimestampShutter(){
        return shutterPC.getTimestamp();
    }
