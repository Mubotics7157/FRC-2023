...
public class PreloadPlusOne extends SequentialCommandGroup{
    ...
    public PreloadPlusOne(Drive drive,VisionManager vision, SuperStructure superStructure,Tracker tracker){
        ...
        addCommands(
         ...
         new DriveBackwards( 1, drive, tracker,PathPlannerTrajectory.transformTrajectoryForAlliance(driveToCubeNodeOne, DriverStation.getAlliance()).getInitialHolonomicPose(),2)),
