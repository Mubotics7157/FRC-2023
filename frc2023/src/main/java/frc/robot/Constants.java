...
public final class Constants {
  ...
  public static class DriveConstants{
    ...
    private static final double FRONT_LEFT_ENCODER_OFFSET = -96.58355712890625;//178.857;//174.0234375;//11.162109375;//2.724609375;
    private static final double FRONT_RIGHT_ENCODER_OFFSET =  -347.51129150390625;//-4.219;//176.1328125;//-110.830078125 ;// -111.263671875;
    private static final double REAR_LEFT_ENCODER_OFFSET = -359.73358154296875;//-169.277;//-4.74609375;//-6.328125;//6-2.263671875;
    private static final double REAR_RIGHT_ENCODER_OFFSET = -108.270263671875;//88.770;//173.759765625   ;//-79.716796875;//-80.439453125;
